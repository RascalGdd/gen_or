...
class HungarianMatcherHOI(nn.Module):
    ...
    def __init__(self, cost_obj_class: float = 1, cost_sub_class: float = 1, cost_verb_class: float = 1, cost_bbox: float = 1,
        ...
        assert cost_obj_class != 0 or cost_sub_class != 0 or cost_verb_class != 0 or cost_bbox != 0 or cost_giou != 0, 'all costs cant be 0'
...
def build_matcher(args):
    return HungarianMatcherHOI(cost_obj_class=args.set_cost_obj_class, cost_sub_class=args.set_cost_sub_class, cost_verb_class=args.set_cost_verb_class,
