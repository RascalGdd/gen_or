...
from datasets.OR_eval import CocoEvaluator
...
def evaluate_hoi(dataset_file, model, postprocessors, data_loader,
    ...
    # elif dataset_file == 'or':
    #     evaluator = CocoEvaluator(preds, gts, data_loader.dataset.correct_mat, use_nms_filter=args.use_nms_filter)
    #
